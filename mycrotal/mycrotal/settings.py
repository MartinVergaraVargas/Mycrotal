...
SECRET_KEY = 'django-insecure-kl%mbb-as9pj3m($8w5#to$49!d=#95c6_&e07lhpif$c+(t&p'
...
WSGI_APPLICATION = 'mycrotal.wsgi.application'
...
GOOGLE_API_KEY = os.environ.get('GMA_Key')
